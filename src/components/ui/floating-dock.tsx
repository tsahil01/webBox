...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-20 gap-4 items-end rounded-2xl bg-zinc-950/60 px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-gray-200 dark:bg-neutral-800/70 flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
